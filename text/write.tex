...
\par Segundo \citeonline{smartsheet}, os quatro valores do manifesto ágil são:
 ...
 \end{enumerate}
 \par E desta maneira possuem os 12 princípios do manifesto ágil, e que são:
\begin{asparaenum}
...
\section{Métodos}
\par Para o desenvovimento desta aula prática foi disponibilizado um roteiro, e segindo este roteiro é porposto um a elaboração de duas etapas, sendo elas:
\begin{enumerate}
  \item Se colocar no lugar do cliente, e pensar e, um aplicativo para a confecção.
  \item Nesta se colocar no lugar do \textit{Product Owner}, e deverá elaborar o aplicativo proposto.
\end{enumerate}
